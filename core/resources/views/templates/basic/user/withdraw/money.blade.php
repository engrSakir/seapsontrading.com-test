                    ...
                    <div class="col-lg-4 col-md-4 mb-4">
                        <div class="card card-deposit">
                            ...
                            <div class="card-body card-body-deposit">
                                <img src="{{get_image(config('constants.withdraw.method.path').'/'. $data->image)}}" class="card-img-top" alt="{{$data->name}}" style="width: 100%">

                                <ul style="font-size: 15px;" class="list-group text-center">
                                    <li class="list-group-item">@lang('Limit') :  {{formatter_money($data->min_limit)}} - {{formatter_money($data->max_limit)}} {{__($data->currency)}}</li>
                            ...
                            <div class="card-footer">
                                <a href="javascript:void(0)"  data-id="{{$data->id}}" data-resource="{{$data}}"
                                   ...
                                   data-base_symbol="{{$data->currency}}" class="btn  amr-btn custom-success deposit" data-toggle="modal" data-target="#exampleModal">
                                    @lang('Withdraw Now')</a>
                            </div>
                        </div>
                    </div>
