            ...
            <div class="table-responsive table-responsive-xl">
                <table class="table align-items-center table-light">
                    ...
                    <tbody class="list">
                        ...
                        <tr>
                            <td>{!! $item->value->icon !!}</td>
                            <td>{{ $item->value->title }}</td>
                            <td><a href="{{ $item->value->url }}">{{ $item->value->url }}</a></td>
                            <td>
                                <button type="button" class="btn btn-rounded btn-primary editBtn" data-title="{{ $item->value->title }}" data-icon="{{ $item->value->icon }}" data-url="{{ $item->value->url }}" data-action="{{ route('admin.frontend.update', $item->id) }}"><i class="fa fa-pencil"></i></button>
