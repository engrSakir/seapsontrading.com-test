                ...
                <div class="table-responsive table-responsive-xl">
                    <table class="table align-items-center table-light">
                        ...
                        @forelse($howItWorks as $testi)
                            <tr>
                                <td scope="row">
                                    <span class="font-weight-bold "><?php echo  @$testi->value->icon; ?></span>
                                </td>
                                <td>
                                    <span class="font-weight-bold">{{ @$testi->value->title }}</span>
                                </td>
                                <td>{{ description_shortener($testi->value->short_details) }}</td>
                                <td>
